  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard title="Tagged Tracks" value={formatNumber(data.taggedTracksTotal)} subtitle={`${formatNumber(data.artistsWithTracks)} artists with catalog`} icon={Music} accent="brand" animationDelay={225} />
      </div>

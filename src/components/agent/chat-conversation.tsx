...
export function ChatConversation({
  ...
  return (
    <StickToBottom className="relative flex min-h-0 flex-1 flex-col" initial="instant" resize="smooth">
      <div className="border-b border-line bg-base-100/90 px-4 py-3 backdrop-blur sm:px-6">
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-3">
          ...
          <Button type="button" variant="ghost" size="sm" onClick={onReset} className="border border-line bg-base-200">

...
| Swayzio OS | Neon project `swayzio-os` (`sparkling-butterfly-49751147`). ELT every 6h via GitHub Actions. Migrations applied through **0020**. Stripe, HubSpot, app DB, Mercury, Facebook, and Instagram feeds are live/available. Semantic recall live (41 rows embedded). |

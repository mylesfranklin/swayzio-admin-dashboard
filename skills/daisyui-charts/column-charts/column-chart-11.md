...
chart: {
    ...
    series: [
      {
        name: "Basic Plan",
        data: [5500, 5200, 5800, 5500, 6700, 7000],
      },
    ],
...
```html
<div
  class="h-72 bg-base-200/80 rounded-box p-7 md:p-10 border-(length:--border) border-base-content/10"
>
  <div class="flex justify-between items-start gap-4 ">
    <div class="flex flex-col gap-1">
      <h2 class="text-sm font-semibold text-base-content/50">Total Revenue</h2>
      <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
        <p class="text-base-content font-bold text-2xl">$14,543</p>
        <span class="text-success font-semibold text-xs">+10.54%</span>
      </div>
    </div>
    <button class="btn btn-xs mt-3">View Report</button>
  </div>

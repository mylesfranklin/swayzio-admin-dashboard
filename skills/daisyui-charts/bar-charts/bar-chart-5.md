...
>
  <div class="flex justify-between items-start gap-4">
    <div class="flex flex-col">
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <div class="flex items-center px-2 py-1 bg-success/10 rounded-selector">
    ...
    <select
      class="select select-sm w-32 mb-auto hidden md:flex font-semibold rounded-field bg-base-300 shadow-2xl border-base-content/10 outline-none focus:ring-0 focus:border-none "
    >
  ...
  <div class="flex gap-2 ml-2">
    <div class="flex items-center gap-1">
      <div class="h-2.5 w-2.5 bg-base-content rounded-selector"></div>
      <p class="text-base-content text-sm">Basic plan</p>
    </div>

    <div class="flex items-center gap-1">
      <div class="h-2.5 w-2.5 bg-base-content/50 rounded-selector"></div>
      <p class="text-base-content text-sm">Premium plan</p>
    </div>
  </div>
</div>
```

...
```javascript
   chart: {
    ...
    series: [
      {
        name: "Revenue",
        data: [4400, 3400, 3700, 4900, 4600, 6200],
      },
    ],
    xaxis: {
...
>
  <div class="flex justify-between items-center mb-6">
    <div>
      ...
      <p class="text-base-content font-semibold text-3xl mt-1">$18,864</p>
    </div>
    <div class="flex flex-col">
      <div class="flex ml-auto items-center text-md font-semibold text-success">
        <svg
          class="w-4 h-4"
          aria-hidden="true"
      ...
      <p class="text-base-content/50 text-sm font-semibold">vs Last 6 months</p>
    </div>
  </div>

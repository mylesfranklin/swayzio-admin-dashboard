...
>
  <div class="flex flex-row justify-between items-center gap-4 mb-6">
    <div class="flex flex-col gap-2">
      ...
      <label class="flex gap-1 items-center cursor-pointer">
        <input
          ...
          checked="checked"
        />
        <h2 class="text-xs font-semibold text-base-content/50">This Year</h2>
      </label>
    </div>
    ...
    <div class="flex flex-col gap-2">
      ...
      <label class="flex gap-1 items-center cursor-pointer">
        <input type="radio" name="radio-1" class="radio radio-xs" />
        <h2 class="text-xs font-semibold text-base-content/50">Last Year</h2>
      </label>
    </div>
  </div>

...
>
  ...
  <div class="flex justify-center gap-2 md:gap-4 mt-2">
    <div class="flex items-center gap-1">
      <div class="size-2 bg-base-content rounded-selector"></div>
      <p class="text-base-content text-xs">Free plan</p>
    </div>
    ...
    <div class="flex items-center gap-1">
      <div class="size-2 bg-base-content/10 rounded-selector"></div>

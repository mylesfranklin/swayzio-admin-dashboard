...
>
  <div
    class="flex flex-row justify-between items-start md:items-center gap-4 mb-6"
  >
    <div>
      <h2 class="text-sm font-semibold text-base-content/50">Total Revenue</h2>
      <div class="flex items-center gap-2">
        <p class="text-base-content font-semibold text-2xl">$45,864</p>
        <span class="text-success text-xs font-semibold mt-2"> + 10% </span>
      </div>
    </div>
  ...
  <div class="flex flex-col gap-7">
    <div class="flex justify-between">
      ...
      <div class="flex items-center gap-1">
        <p class="text-base-content font-semibold text-xs">$25,864</p>
    ...
    <div class="flex justify-between">
      ...
      <div class="flex items-center gap-1">
        <p class="text-base-content font-semibold text-xs">$14,258</p>
    ...
    <div class="flex justify-between">
      ...
      <div class="flex items-center gap-1">
        <p class="text-base-content font-semibold text-xs">$5,258</p>

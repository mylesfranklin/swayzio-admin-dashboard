 ...
 * GitHub Actions sync workflow (.github/workflows/os-sync.yml) that re-pulls Stripe/HubSpot/app/Mercury/Facebook into
...
export default defineTool({
  description:
    "Trigger a fresh sync of Swayzio OS — re-pull Stripe/HubSpot/app/Mercury/Facebook data into the brain — by dispatching " +
  ...
  inputSchema: z.object({
    ...
    feeds: z
      .array(z.enum(["stripe", "hubspot", "app", "mercury", "facebook"]))
      .optional()
